/**
 * Provided by the MarvinJS team, no idea what this file is doing
 */
...
(function(win) {
    ...
    function _createPackage(elementId, resolve, reject) {
        ...
        let wrapperElement = _getWrapperElement(elementId);
        ...
        let marvinPackage = _getPackage(wrapperElement);
        if (marvinPackage) {
            ...
            wrapperElement.addEventListener('load', function handleSketchLoad(e) {
                let marvin = _getPackage(wrapperElement);
                if (marvin) {
